...
public class EarthquakeCityMap extends PApplet {
	...
	public void setup() {		
		...
		//earthquakesURL = "module4/test1.atom";
		//earthquakesURL = "module4/test2.atom";
		
		// WHEN TAKING THIS QUIZ: Uncomment the next line
		earthquakesURL = "module4/quiz1.atom";
...
//		ellipse(50, 225, 5, 5);
		...
		text("deep", 75,375);
		text("size ~ magnitude", 50, 425);
		fill(color(255,255,255));
		ellipse(50,175,15,15);
		rect(42.5f,217.5f,15,15);
		fill(255,255,0);
...
//		text("Below 4.0", 75, 225);
	...
	private void printQuakes() 
	{
		...
		HashMap<String, Integer > cNum  = new HashMap();
		int ocean = 0;
		for(Marker m: quakeMarkers){
			EarthquakeMarker q = (EarthquakeMarker) m;
			if(q.isOnLand()){
				String c = (String) q.getProperty("country");
				if(cNum.containsKey(c)) cNum.put(c,cNum.get(c) +1);
				else cNum.put(c,1);
			}else{
				ocean++;
			}
		}
		for (Map.Entry<String,Integer> kv: cNum.entrySet()){
